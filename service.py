...
class Service:
    ...
    def get_price_from_trendyol(self, search_value):
        ...
        if result:
            ...
            self.get_price_from_amazon(search_value)
    ...
    def get_price_from_amazon(self, search_value):
        ...
        if result:
            ...
            self.get_price_from_hepsiburada(search_value)
        else:
    ...
    def get_price_from_hepsiburada(self, search_value):
        try:
            ...
            search_input_element = self.driver.find_element(By.CLASS_NAME, 'theme-IYtZzqYPto8PhOx3ku3c')
...
service = Service()
service.get_price_from_trendyol("playstation 5")
